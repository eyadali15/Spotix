/**
 * Spotix — Client Tab Layout (Light + i18n)
 */
...
export default function ClientLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarShowLabel: false, tabBarStyle: styles.tabBar }}>
      <Tabs.Screen name="index" options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🗺️" labelKey="tabHome" focused={focused} /> }} />
      <Tabs.Screen name="reservations" options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🎟️" labelKey="tabTickets" focused={focused} /> }} />
      ...
      <Tabs.Screen name="reserve" options={{ href: null, tabBarStyle: { display: 'none' } }} />
...
const styles = StyleSheet.create({
  ...
  emojiWrapActive: { backgroundColor: Colors.secondaryFaded },
  ...
  tabLabelActive: { color: Colors.secondary, fontWeight: FontWeights.bold },
